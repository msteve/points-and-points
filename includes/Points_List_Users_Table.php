...
class Points_List_Users_Table extends WP_List_Table {
    ...
    //print_r(( ( $current_page>1?$current_page-1:$current_page )* $per_page ));
   // print_r($current_page);
    $this->found_data = array_slice( $this->example_data,( ( $current_page>1?$current_page-1:$current_page )* $per_page ), $per_page );
    //$this->found_data =$this->example_data;
    $this->set_pagination_args( array(
        'total_items' => $total_items,                  //WE have to calculate the total number of items
        'per_page'    => $per_page                     //WE have to determine how many items to show on a page
    ) );
    //echo " Data >>>";
   // print_r($this->found_data);
   ...
   /* function display() {
       // array( 'ID' => 1,'booktitle' => 'Quarter Share', 'author' => 'Nathan Lowell', 
       // 'isbn' => '978-0982514542' ),
        foreach($this->example_data as $data ){
            ?>
           <!-- <tr>
